...
set -x
if [ $# -ne 7 ]; then
  echo "Usage: acryl-executor-ecs-stack.sh <Stack_Name> <DataHubBaseUrl> <DataHubAccessToken> <AwsAccessKeyId> <AwsSecretAccessKey> <AwsRegion> <AwsCommandQueueUrl> <AwsCommandQueueArn>"
